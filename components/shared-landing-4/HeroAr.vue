        ...
        <div class="row justify-content-center text-center">
          <div class="col-lg-10">
            <h1 class="hero-title animate-up">
              <span class="text-gold">خدمات قانونية موثوقة</span><br>
              <span class="text-white">باحترافية عالية</span>
            </h1>
...
<script setup>
// Props preserved for future flexibility, defaults now match the specific image request
defineProps({
  title: {
    type: String,
    default: ''
