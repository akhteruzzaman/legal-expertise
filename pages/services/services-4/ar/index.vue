...
import ServicesGridAr from '@/components/services-4/ServicesGridAr.vue'
import CTAAr from '@/components/services-4/CTAAr.vue'
import FooterAr from '@/components/services-4/FooterAr.vue'

useHead({
  title: 'خدماتنا 4 | مكتب الرياض للمحاماة',
  htmlAttrs: {
    lang: 'ar',
    dir: 'rtl'
  },
