...
import HeroAr from '@/components/about-3/HeroAr.vue'
import MissionAr from '@/components/about-1/MissionAr.vue'
import WhyUsAr from '@/components/about-3/WhyUsAr.vue'
...
useHead({
  title: 'مكتب الرياض للمحاماة | خبرة قانونية موثوقة (About 3)',
  htmlAttrs: {
    lang: 'ar',
    dir: 'rtl'
  },
