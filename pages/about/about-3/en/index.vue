...
import HeroEn from '@/components/about-3/HeroEn.vue'
import MissionEn from '@/components/about-1/MissionEn.vue'
import WhyUsEn from '@/components/about-3/WhyUsEn.vue'
...
useHead({
  title: 'Al Riyadh Law Firm | Trusted Legal Expertise (About 3)',
  htmlAttrs: {
    lang: 'en',
    dir: 'ltr'
  },
