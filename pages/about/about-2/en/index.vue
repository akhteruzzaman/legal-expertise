...
import HeroEn from '@/components/about-2/HeroEn.vue'
import MissionEn from '@/components/about-1/MissionEn.vue'
import WhyUsEn from '@/components/about-1/WhyUsEn.vue'
...
useHead({
  title: 'Al Riyadh Law Firm | Trusted Legal Expertise (About 2)',
  htmlAttrs: {
    lang: 'en',
    dir: 'ltr'
  },
